...
export const SERVICE_EDGE = [
  ...
  { icon: "gem", zh: "依照需求專業選品", en: "Personalized Curation", desc: "依照您的配戴需求、預算與風格偏好，精選多元品牌與合適錶款選擇。" },
];
...
export const REPAIR_FLOW = [
  { n: "1", zh: "檢測", en: "Inspection", desc: "初步確認手錶狀況與問題來源", arrow: "→" },
  { n: "2", zh: "報價", en: "Quotation", desc: "說明維修內容、費用與所需時間", arrow: "→" },
  { n: "3", zh: "訂購零件", en: "Parts Order", desc: "若需更換零件，確認料件狀況", arrow: "→" },
  { n: "4", zh: "維修更換", en: "Repair", desc: "由技術人員進行維修與處理", arrow: "→" },
  { n: "5", zh: "組裝檢測", en: "Assembly & Test", desc: "完成後進行功能與狀態檢查", arrow: "→" },
  { n: "6", zh: "完成交件", en: "Handover", desc: "通知顧客取件並說明注意事項", arrow: "" },
];
